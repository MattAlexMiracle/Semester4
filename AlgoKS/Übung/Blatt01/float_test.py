...
if __name__ == "__main__":
    ...
    ###############################
    check("Aufgabe 2a: Exponentialfunktion", 2, "float",
          imports = ["math", "numpy"],
          calls = [
              (("myexp", 0.0), 1.0),
              (("myexp", 1.0), 2.7182818284590455),
              (("myexp", 2.0), 7.389056098930649),
              (("myexp", -1.0), 0.36787944117144245),
          ])

    check("Aufgabe 2b: Numerische Differentiation, diff1", 1, "float",
          imports = ["math", "numpy"],
          calls = [
    ...
    check("Aufgabe 2b: Numerische Differentiation, diff2", 1, "float",
          imports = ["math", "numpy"],
          calls = [
